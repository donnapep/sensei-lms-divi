<?php
/**
 * Sensei LMS Lesson Description module.
 *
 * @since 1.0.0
 */
class Sensei_Lesson_Description extends ET_Builder_Module {
	/**
	...
	public function init() {
		$this->name       = esc_html__( 'Lesson Description', 'sensei-divi' );
		$this->plural     = esc_html__( 'Lesson Descriptions', 'sensei-divi' );
		$this->slug       = 'sensei_lesson_description';
		$this->icon       = '3';
		$this->vb_support = 'on';
			...
			'fonts' => array(
				...
				'body' => array(
					...
					'css'   => array(
						...
						'color'       => '%%order_class%%.sensei_lesson_description',
					),
					'line_height' => array(
				...
				'link' => array(
					...
					'css' => array(
						'main'  => '%%order_class%% a',
						'color' => '%%order_class%%.sensei_lesson_description a',
					),
					'line_height' => array(
						'default' => '1em',
					),
				...
				'ul' => array(
					...
					'css'   => array(
						'main'        => '%%order_class%% ul',
						'color'       => '%%order_class%%.sensei_lesson_description ul',
				...
				'ol' => array(
					...
					'css'   => array(
						'main'        => '%%order_class%% ol',
						'color'       => '%%order_class%%.sensei_lesson_description ol',
				...
				'quote' => array(
					...
					'css'   => array(
						...
						'color' => '%%order_class%%.sensei_lesson_description blockquote',
					),
					'line_height' => array(
						'default' => '1em',
					),
	...
	protected function get_description() {
		...
		if ( 'description' === $description_type ) {
			return wp_kses_post( $lesson->post_content );
		} else {
			return wp_kses_post( $lesson->post_excerpt );
		}
	}
